...
final class get_info_test extends \advanced_testcase {
     ...
     *
     * @covers \local_pluginsfetcher\external\get_info::execute_parameters
     *
     * @return void
     */
     ...
     *
     * @covers \local_pluginsfetcher\external\get_info::execute_returns
     *
     * @return void
     */
    ...
    public function test_execution(): void {
        ...
        $result = get_info::execute(null, false);

        // Check that the result is an array.
        $this->assertIsArray($result, 'The result should be an array.');

        // Check that the result contains the expected keys.
        $this->assertArrayHasKey('plugins', $result, 'The result should contain a "plugins" key.');
